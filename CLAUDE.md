...
```bash
sonar analyze agentic --project Sonar-Gitar-Demos_Customer-Pulse --depth DEEP --file <path/to/file1> --file <path/to/file2>
```
...
```bash
sonar analyze agentic --project Sonar-Gitar-Demos_Customer-Pulse --depth DEEP
```
